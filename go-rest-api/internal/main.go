...
import (
	...
	"github.com/yogiyiorgos/goProjects/go-rest-api/pkg/swagger/server/restapi"
	"github.com/yogiyiorgos/goProjects/go-rest-api/pkg/swagger/server/restapi/operations"
)
...
// GetGelloUser returns Hello + your name
...
func GetGopherByName(gopher operations.GetGopherNameParams) middleware.Responder {
	...
	if gopher.Name != "" {
		...
		// The default return is dr-who gopher
